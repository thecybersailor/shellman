...
func TestMigrateUp_AddsTaskRuntimeAndTaskColumns(t *testing.T) {
	...
	mustHaveColumns(t, db, "tasks", []string{
		"task_id", "project_id", "parent_task_id", "title", "current_command", "active_adapter", "status", "sidecar_mode", "task_role", "description", "flag", "flag_desc", "checked", "archived", "last_modified",
	})
